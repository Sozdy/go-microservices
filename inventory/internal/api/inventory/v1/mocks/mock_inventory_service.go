...
func (_mock *InventoryService) ListParts(ctx context.Context, partUUIDs []string, partType model.PartType) ([]*model.Part, error) {
...
func (_e *InventoryService_Expecter) ListParts(ctx interface{}, partUUIDs interface{}, partType interface{}) *InventoryService_ListParts_Call {
	return &InventoryService_ListParts_Call{Call: _e.mock.On("ListParts", ctx, partUUIDs, partType)}
}

func (_c *InventoryService_ListParts_Call) Run(run func(ctx context.Context, partUUIDs []string, partType model.PartType)) *InventoryService_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *InventoryService_ListParts_Call) RunAndReturn(run func(ctx context.Context, partUUIDs []string, partType model.PartType) ([]*model.Part, error)) *InventoryService_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
